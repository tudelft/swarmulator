...
extern std::vector<Agent *> agents; // Set up a vector of agents
extern float simtime_seconds; // Adjusted simulation time (time according to simulation)
extern std::shared_mutex main_mutex; // Mutex object
extern std::shared_mutex environment_mutex; // Mutex object
