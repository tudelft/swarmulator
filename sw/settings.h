...
#define MEAS_NOISE_VX 0.1    // stdev of measurement noise on velocity (x), in [m/s]
#define MEAS_NOISE_VY 0.1    // stdev of measurement noise on velocity (y), in [m/s]
#define MEAS_NOISE_DPSI 0.01  // stdev of measurement noise on yaw rate in [rad/s]
#define MEAS_NOISE_PSI 0.01  // stdev of measurement noise on yaw measurement [rad/s]

#define COMMUNICATION_RANGE 80
#define COMMUNICATION_BASE_INTERVAL 0.05
